...
#endif
#if defined(_MSC_VER)
// MSVC has no __attribute__((cold)): empty so it composes with the __declspec(noinline) it is
// always paired with (MKW_MEMORY_NO_INLINE MKW_MEMORY_COLD <fn> below). See ppc_isa_config.h.
