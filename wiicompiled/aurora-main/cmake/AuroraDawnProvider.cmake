...
if (_aurora_dawn_provider STREQUAL "vendor")
  ...
  if (NOT TARGET webgpu_dawn)
    ...
    # Respect a caller-set DAWN_FETCH_DEPENDENCIES (the UWP target pre-sets OFF
    # to build from the vendored local dep trees offline). Default ON otherwise.
    if (NOT DEFINED DAWN_FETCH_DEPENDENCIES)
